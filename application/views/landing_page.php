...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            </head><i class="bi bi-house-fill"></i></button>
            </a>
    ...
    <div class="fullscreen-bg">
        <img src="<?php echo base_url('assets/img/Home.jpeg'); ?>" alt="Foto" class="fullscreen-background">
        <div class="overlay-text">
        <div><h1>Gallery Foto</h1></div>
        <button class="btn btn-outline-info me-2" type="button"> <p class="text-white">Aplikasi website Gallery Foto ini untuk menyediakan sebuah platform yang
             mudah digunakan, aman, dan dapat diakses oleh siapa saja untuk memamerkan, menyimpan, dan berbagi foto.</p></button>
        </div>
    </div>
